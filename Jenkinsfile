...
pipeline {
    ...
    environment {
        dockerhub_repo = "deephdc/{% if cookiecutter.git_base_url == 'https://github.com/deephdc' %}deep-oc-{{ cookiecutter.repo_name }}{% else -%}uc-{{ cookiecutter.git_base_url.split('/')[-1] }}-deep-oc-{{ cookiecutter.repo_name }}{% endif %}"
        base_cpu_tag = "cpu"
        base_gpu_tag = "gpu"
    }
